...
\setNombreAsignatura{Ingeniería de Software III}
\setNombreProfesor{}
...
{CS1704145} %Código de la asignatura
...
{CS1703237} % Prerrequisitos (separados por comas)
...
\cite{Pressman2014}, \cite{Sommerville2010} 
...
%inicio unidad
\nextUnidad{\SESoftwareProcesses}
\nextCapitulo{\SESoftwareProcesses}
\nextTema{\SESoftwareProcessesTopicSystem}
\nextTema{\SESoftwareProcessesTopicIntroduction}
\nextTema{\SESoftwareProcessesTopicProgramming}
\nextTema{\SESoftwareProcessesTopicEvaluation}
\nextTema{\SESoftwareProcessesTopicSoftware}
\nextTema{\SESoftwareProcessesTopicProcess}
\nextTema{\SESoftwareProcessesTopicSoftwareProcess}
\nextTema{\SESoftwareProcessesTopicSoftwareProcessMeasurements}

\cite{Pressman2014}, \cite{Sommerville2010} 


%inicio unidad
\nextUnidad{Estándares ISO/IEC}
\nextCapitulo{Estándares ISO/IEC}
\nextTema{ISO 9001:2001.}
\nextTema{ISO 9000-3.}
\nextTema{ISO/IEC 9126.}
\nextTema{ISO/IEC 12207.}
\nextTema{ISO/IEC 15939.}
\nextTema{ISO/IEC 14598.}
\nextTema{ISO/IEC 15504-SPICE.}
\nextTema{IT Mark.}
\nextTema{SCRUM.}
\nextTema{SQuaRE.}
\nextTema{CISQ.}

\cite{Sommerville2010}, \cite{Pressman2014} 
