...
\setNombreAsignatura{Ingeniería de Software II}
\setNombreProfesor{}
...
{CS1703237} %Código de la asignatura
...
{CS1703132} % Prerrequisitos (separados por comas)
...
%inicio unidad
\nextUnidad{\SEToolsandEnvironments}
\nextCapitulo{\SEToolsandEnvironments}
\nextTema{\SEToolsandEnvironmentsTopicSoftware}
\nextTema{\SEToolsandEnvironmentsTopicRelease}
\nextTema{\SEToolsandEnvironmentsTopicRequierements}
\nextTema{\SEToolsandEnvironmentsTopicTesting}
\nextTema{\SEToolsandEnvironmentsTopicProgramming}
\nextTema{\SEToolsandEnvironmentsTopicTool}
...
%inicio unidad
\nextUnidad{\SESoftwareVerificationandValidation}
\nextCapitulo{\SESoftwareVerificationandValidation}
\nextTema{\SESoftwareVerificationandValidationTopicVerification}
\nextTema{\SESoftwareVerificationandValidationTopicInspections}
\nextTema{\SESoftwareVerificationandValidationTopicTesting}
\nextTema{\SESoftwareVerificationandValidationTopicTestingFundamentals}
\nextTema{\SESoftwareVerificationandValidationTopicDefect}
\nextTema{\SESoftwareVerificationandValidationTopicLimitations}
\nextTema{\SESoftwareVerificationandValidationTopicStatic}
\nextTema{\SESoftwareVerificationandValidationTopicTest}
\nextTema{\SESoftwareVerificationandValidationTopicValidation}
\nextTema{\SESoftwareVerificationandValidationTopicObject}
\nextTema{\SESoftwareVerificationandValidationTopicVerificationAnd}
\nextTema{\SESoftwareVerificationandValidationTopicFault}
\nextTema{\SESoftwareVerificationandValidationTopicFaultEstimation}

\cite{Pressman04}, \cite{Blum92}, \cite{Schach04}, \cite{Wang00}, \cite{Keyes04}, \cite{Windle02}, \cite{Priest01}, \cite{Schach04}, \cite{Montangero96}, \cite{Ambriola01}, \cite{Conradi00}, \cite{Oquendo03} 


%inicio unidad
\nextUnidad{\SESoftwareEvolution}
\nextCapitulo{\SESoftwareEvolution}
\nextTema{\SESoftwareEvolutionTopicSoftware}
\nextTema{\SESoftwareEvolutionTopicSoftwareEvolution}
\nextTema{\SESoftwareEvolutionTopicCharacteristics}
\nextTema{\SESoftwareEvolutionTopicReengineering}
\nextTema{\SESoftwareEvolutionTopicSoftwareReuse}
