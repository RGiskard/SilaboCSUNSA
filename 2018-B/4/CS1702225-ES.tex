...
\setNombreAsignatura{Teoría de la Computación}
\setNombreProfesor{}
...
{CS1702225} %Código de la asignatura
...
\nextTema{\ALBasicAutomataComputabilityandComplexityTopicFinite}
\nextTema{\ALBasicAutomataComputabilityandComplexityTopicRegular}
\nextTema{\ALBasicAutomataComputabilityandComplexityTopicThe}
\nextTema{\ALBasicAutomataComputabilityandComplexityTopicContext}
\nextTema{\ALBasicAutomataComputabilityandComplexityTopicIntroduction}
\nextTema{\ALBasicAutomataComputabilityandComplexityTopicIntroductionTo}
\nextTema{\ALAdvancedAutomataTheoryandComputabilityTopicTuring}
\nextTema{\ALAdvancedAutomataTheoryandComputabilityTopicNondeterministic}
\nextTema{\ALAdvancedAutomataTheoryandComputabilityTopicChomsky}
\nextTema{\ALAdvancedAutomataTheoryandComputabilityTopicThe}
\nextTema{\ALAdvancedAutomataTheoryandComputabilityTopicComputability}
\nextTema{\ALAdvancedAutomataTheoryandComputabilityTopicRices}
\nextTema{\ALAdvancedAutomataTheoryandComputabilityTopicExamples}
\nextTema{\ALAdvancedAutomataTheoryandComputabilityTopicImplications}

\cite{Kolman97}, \cite{Kelley95} 


%inicio unidad
\nextUnidad{\ALAdvancedComputationalComplexity}
\nextCapitulo{\ALAdvancedComputationalComplexity}
\nextTema{\ALAdvancedComputationalComplexityTopicReview}
\nextTema{\ALAdvancedComputationalComplexityTopicPolynomial}
\nextTema{\ALAdvancedComputationalComplexityTopicNp}
\nextTema{\ALAdvancedComputationalComplexityTopicClassic}
\nextTema{\ALAdvancedComputationalComplexityTopicReduction}

\cite{Kelley95}, \cite{Hopcroft93} 


%inicio unidad
\nextUnidad{\ALAdvancedAutomataTheoryandComputability}
\nextCapitulo{\ALAdvancedAutomataTheoryandComputability}
\nextTema{\ALAdvancedAutomataTheoryandComputabilityTopicSets}
\nextTema{\ALAdvancedAutomataTheoryandComputabilityTopicContext}

\cite{Hopcroft93}, \cite{Brookshear93} 
