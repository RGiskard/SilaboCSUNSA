...
\setNombreAsignatura{Inglés técnico profesional I}
\setNombreProfesor{}
...
{ID1701105} %Código de la asignatura
...
%inicio unidad
\nextUnidad{Hello everybody}
\nextCapitulo{Hello everybody}
\nextTema{Verbo To Be.}
\nextTema{Oraciones Afirmativas, Negativas y Preguntas.}
\nextTema{Expresiones Numéricas.}
\nextTema{Objetos y Paí­ses.}
\nextTema{Expresiones para saludar y hacer presentaciones.}

\cite{Soars022S}, \cite{Cambridge06}, \cite{MacGrew99} 


%inicio unidad
\nextUnidad{Meeting people}
\nextCapitulo{Meeting people}
\nextTema{Adjetivos Posesivos.}
\nextTema{Expresiones para averiguar precios.}
\nextTema{Expresiones de Posesión.}
\nextTema{Vocabulario de Familia, Comidas y Bebidas.}
\nextTema{Pedidos formales.}
\nextTema{Cartas informales.}
...
\nextTema{Tiempo Presente Simple. Auxiliares.}
\nextTema{Oraciones Afirmativas, Negativas y Preguntas.}
\nextTema{Verbos comunes y Ocupaciones.}
\nextTema{Indicaciones para expresar la hora.}

\cite{Soars022S}, \cite{Cambridge06}, \cite{MacGrew99} 


%inicio unidad
\nextUnidad{Take it easy}
\nextCapitulo{Take it easy}
\nextTema{Presente Simple 2.}
\nextTema{Oraciones Afirmativas, Negativas y Preguntas.}
\nextTema{Uso de Verbos de entretenimiento.}
\nextTema{Tiempo Libre.}
\nextTema{Las estaciones del año.}
\nextTema{Expresiones de actividades sociales.}

\cite{Soars022S}, \cite{Cambridge06}, \cite{MacGrew99} 


%inicio unidad
\nextUnidad{Where do you live ?}
\nextCapitulo{Where do you live ?}
\nextTema{Uso There is/There are.}
\nextTema{Oraciones con Preposiciones.}
\nextTema{Expresiones de Cantidad.}
\nextTema{Vocabulario de aviones y lugares.}
\nextTema{Expresiones de indicaciones de dirección.}

\cite{Soars022S}, \cite{Cambridge06}, \cite{MacGrew99} 


%inicio unidad
\nextUnidad{Can you speak English?}
\nextCapitulo{Can you speak English?}
\nextTema{Can/cant.}
\nextTema{Pasado del verbo To Be. Uso de Could.}
\nextTema{Vocabulario de países e idiomas.}
\nextTema{Expresiones para el uso del teléfono.}
\nextTema{Redacción de cartas formales.}
\nextTema{Lecturas.}
...
%inicio unidad
\nextUnidad{Then and now}
\nextCapitulo{Then and now}
\nextTema{Pasado Simple.}
\nextTema{Expresiones de tiempo pasado.}
\nextTema{Vocabulario verbos regulares e irregulares.}
\nextTema{Expresiones para describir el clima.}
\nextTema{Redacción de párrafos descriptivos.}
\nextTema{Ocasiones Especiales.}
