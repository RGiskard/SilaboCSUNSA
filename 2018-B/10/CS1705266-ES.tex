...
\setNombreAsignatura{Proyecto de Final de Carrera III}
\setNombreProfesor{}
...
{CS1705266} %Código de la asignatura
...
{CS1705156} % Prerrequisitos (separados por comas)
...
\begin{sumilla}
\item Escritura del Borrador del trabajo de final de carrera (tesis)
...
%inicio unidad
\nextUnidad{Escritura del Borrador del trabajo de final de carrera (tesis)}
\nextCapitulo{Escritura del Borrador del trabajo de final de carrera (tesis)}
\nextTema{Redacción y correccion del trabajo de final de carrera}

\cite{ieee}, \cite{acm}, \cite{citeseer} 
