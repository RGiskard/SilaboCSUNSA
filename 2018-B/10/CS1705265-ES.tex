...
\setNombreAsignatura{Cloud Computing}
\setNombreProfesor{}
...
%inicio unidad
\nextUnidad{\PDDistributedSystems}
\nextCapitulo{\PDDistributedSystems}
\nextTema{\PDDistributedSystemsTopicFaults}
\nextTema{\PDDistributedSystemsTopicDistributed}
\nextTema{\PDDistributedSystemsTopicDistributedSystem}
\nextTema{\PDDistributedSystemsTopicDistributedService}
\nextTema{\PDDistributedSystemsTopicCore}

\cite{coulouris} 


%inicio unidad
\nextUnidad{\PDCloudComputing}
\nextCapitulo{\PDCloudComputing}
\nextTema{Visión global de {\it Cloud Computing}.}
\nextTema{Historia.}
\nextTema{Visión global de las tecnologias que envuelve.}
\nextTema{Beneficios, riesgos y aspectos económicos.}
\nextTema{\PDCloudComputingTopicCloud}
\nextTema{\PDCloudComputingTopicInternet}

\cite{dongarra}, \cite{buyya} 


%inicio unidad
\nextUnidad{Centros de Procesamiento de Datos}
\nextCapitulo{Centros de Procesamiento de Datos}
\nextTema{Visión global de un centro de procesamiento de datos.}
\nextTema{Consideraciones en el diseño.}
\nextTema{Comparación de actuales grandes centros de procesamiento de datos.}
...
\nextUnidad{\PDCloudComputing}
\nextCapitulo{\PDCloudComputing}
\nextTema{\PDCloudComputingTopicVirtualization}
\nextTema{Seguridad, recursos y isolamiento de fallas.}
\nextTema{Almacenamiento como servicio.}
\nextTema{Elasticidad.}
\nextTema{Xen y WMware.}
\nextTema{Amazon EC2.}
...
\nextUnidad{\PDCloudComputing}
\nextCapitulo{\PDCloudComputing}
\nextTema{\PDCloudComputingTopicCloudBased}
\nextTema{Visión global sobre tecnologías de almacenamiento.}
\nextTema{Conceptos fundamentales sobre almacenamiento en la cloud.}
\nextTema{Amazon S3 y EBS.}
\nextTema{Sistema de archivos distribuidos.}
\nextTema{Sistema de bases de datos NoSQL.}

\cite{dongarra}, \cite{buyya} 


%inicio unidad
\nextUnidad{Modelos de Programación}
\nextCapitulo{Modelos de Programación}
\nextTema{Visión global de los modelso de programación basados en cloud computing.}
\nextTema{Modelo de Programación MapReduce.}
\nextTema{Modelo de programación para aplicaciones basadas en Grafos.}

\cite{dongarra}, \cite{buyya}, \cite{graphlab}, \cite{pregel}, \cite{giraph} 
