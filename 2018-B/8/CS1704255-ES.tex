...
\setNombreAsignatura{Tópicos en Ingeniería de Software}
\setNombreProfesor{}
...
{CS1704255} %Código de la asignatura
...
{CS1704145} % Prerrequisitos (separados por comas)
...
\nextUnidad{}
\nextCapitulo{}
\nextTema{Administración del servicio como práctica.}
\nextTema{Ciclo de vida del servicio.}
\nextTema{Definiciones y conceptos genéricos.}
\nextTema{Modelos y principios claves.}
\nextTema{Procesos.}
\nextTema{Tecnología y arquitectura.}
\nextTema{Competencia y entrenamiento.}
...
\nextUnidad{}
\nextCapitulo{}
\nextTema{Fundamentos e Introducción.}
\nextTema{Frameworks de Control y IT Governance.}
