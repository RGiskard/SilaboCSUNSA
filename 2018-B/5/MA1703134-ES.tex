...
\setNombreAsignatura{Análisis Exploratorio de Datos Espaciales}
\setNombreProfesor{}
...
{MA1703134} %Código de la asignatura
...
{MA1702228,CS1702224} % Prerrequisitos (separados por comas)
...
\nextUnidad{}
\nextCapitulo{}
\nextTema{Presentación de datos}
\nextTema{Medidas de localización central}
\nextTema{Medidas de dispersión}
...
\nextUnidad{}
\nextCapitulo{}
\nextTema{Espacios muestrales y eventos}
\nextTema{Axiomas y propiedades de probabilidad}
\nextTema{Probabilidad condicional}
\nextTema{Independencia,}
\nextTema{Teorema de Bayes}
...
\nextUnidad{}
\nextCapitulo{}
\nextTema{Definición y tipos de variables aleatorias}
\nextTema{Distribución de probabilidades}
\nextTema{Funciones densidad}
\nextTema{Valor esperado}
\nextTema{Momentos}

\cite{Meyer70}, \cite{Devore98} 


%inicio unidad
\nextUnidad{}
\nextCapitulo{}
\nextTema{Distribuciones de probabilidad básicas}
\nextTema{Densidades de probabilidad básicas}
\nextTema{Funciones de variable aleatoria}
...
\nextUnidad{}
\nextCapitulo{}
\nextTema{Variables aleatorias distribuidas conjuntamente}
\nextTema{Valores esperados, covarianza y correlación}
\nextTema{Las estadísticas y sus distribuciones}
\nextTema{Distribución de medias de muestras}
\nextTema{Distribución de una combinación lineal}
...
\nextUnidad{}
\nextCapitulo{}
\nextTema{Estimación estadística}
\nextTema{Prueba de hipótesis}
\nextTema{Prueba de hipótesis usando ANOVA}
