...
\setNombreAsignatura{Liderazgo y Desempeño}
\setNombreProfesor{}
...
{FG1005262} %Código de la asignatura
...
Este desafío, pasa por la necesidad de formar a nuestros alumnos con un recto conocimiento de sí mismos, con capacidad de juzgar objetivamente la realidad y de proponer  orientaciones que busquen modificar positivamente el entorno.  
\end{fundamentacion}
...
\nextUnidad{}
\nextCapitulo{}
\nextTema{Teorías de Liderazgo:}
\nextTema{Definición de Liderazgo.}
\nextTema{Fundamentos de Liderazgo.}
\nextTema{Visión integral del Ser Humano y Motivos de la acción.}
\nextTema{La práctica de la Virtud en el ejercicio de Liderazgo.}

\cite{Cardona}, \cite{Ferreiro}, \cite{Dianine}, \cite{DSouza}, \cite{Sonnenfeld} 


%inicio unidad
\nextUnidad{}
\nextCapitulo{}
\nextTema{Teoría de las Competencias}
\nextTema{Reconocimiento de Competencias}
\nextTema{Plan de Desarrollo}
\nextTema{Modelos Mentales}
\nextTema{Necesidades Emocionales}
\nextTema{Perfiles Emocionales}
\nextTema{Vicios Motivacionales}

\cite{Wilkinson}, \cite{Huete}, \cite{Cardona}, \cite{Chinchilla} 


%inicio unidad
\nextUnidad{}
\nextCapitulo{}
\nextTema{La relación personal con el equipo}
\nextTema{Liderazgo integral}
\nextTema{Acompañamiento y discipulado}
\nextTema{Fundamentos de unidad}

\cite{Goleman}, \cite{CardonaP}, \cite{Hersey}, \cite{Hunsaker}, \cite{Hawkins}, \cite{Ginebra} 
