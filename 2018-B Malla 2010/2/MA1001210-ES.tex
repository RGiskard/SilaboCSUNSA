...
\setNombreAsignatura{Cálculo en una Variable I}
\setNombreProfesor{}
...
{MA1001210} %Código de la asignatura
...
{MA1001103} % Prerrequisitos (separados por comas)
...
%inicio unidad
\nextUnidad{Multi-Variable Function Differential}
\nextCapitulo{Multi-Variable Function Differential}
\nextTema{Concepto de funciones multi-variables.}
\nextTema{Derivados Direccionales}
\nextTema{Línea tangente, plano normal a línea de curva y plano tangente, línea normal a un plano de curva. Conocer para calcular sus ecuaciones.}
\nextTema{Concepto de valor extremo y valor extremo condicional de funciones multi-variables.}
\nextTema{Problemas de aplicación tales como modelización de la producción total de un sistema económico, velocidad del sonido a través del océano, optimización del espesante, etc.}

\cite{Stewart}, \cite{DennisZ} 


%inicio unidad
\nextUnidad{Multi-Variable function Integral}
\nextCapitulo{Multi-Variable function Integral}
\nextTema{Integral doble, integral triple y naturaleza de la integral múltiple.}
\nextTema{Método de doble integral}
\nextTema{Línea integral}
\nextTema{La Divergencia, Rotación y Laplaciano}
...
\nextUnidad{Series}
\nextCapitulo{Series}
\nextTema{Serie convergente.}
\nextTema{Serie Taylor y MacLaurin.}
\nextTema{Funciones ortogonales.}

\cite{Stewart}, \cite{DennisZ} 


%inicio unidad
\nextUnidad{Ordinary Differential Equations}
\nextCapitulo{Ordinary Differential Equations}
\nextTema{Concepto de ecuaciones diferenciales}
\nextTema{Métodos para resolver ecuaciones diferenciales}
\nextTema{Métodos para resolver las ecuaciones diferenciales lineales de segundo orden}
\nextTema{Ecuaciones diferenciales ordinarias lineales de orden superior}
\nextTema{Problemas de aplicaciones con las transformaciones de Laplace}
