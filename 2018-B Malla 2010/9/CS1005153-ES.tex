...
\setNombreAsignatura{Tópicos en Inteligencia Artificial}
\setNombreProfesor{}
...
{CS1005153} %Código de la asignatura
...
{CS1004138} % Prerrequisitos (separados por comas)
...
\nextUnidad{}
\nextCapitulo{}
\nextTema{CS360. Sistemas Inteligentes}
\nextTema{CS361. Razonamiento automatizado}
\nextTema{CS362. Sistemas Basados en Conocimiento}
\nextTema{CS363. Aprendizaje de Maquina \cite{Russell03},\cite{Haykin99}}
\nextTema{CS364. Sistemas de Planeamiento}
\nextTema{CS365. Procesamiento de Lenguaje Natural}
\nextTema{CS366. Agentes}
\nextTema{CS367. Robótica}
\nextTema{CS368. Computación Simbólica}
\nextTema{CS369. Algoritmos Genéticos \cite{Goldberg89}}

\cite{Russell03}, \cite{Haykin99}, \cite{Goldberg89} 
