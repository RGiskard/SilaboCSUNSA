...
\setNombreAsignatura{Análisis Numérico}
\setNombreProfesor{}
...
{MA1003128} %Código de la asignatura
...
{MA1002222} % Prerrequisitos (separados por comas)
...
\nextUnidad{}
\nextCapitulo{}
\nextTema{Aritmética de punto flotante}
\nextTema{Error, estabilidad, convergencia.}
\nextTema{Series de Taylor}

\cite{Burden02}, \cite{Kinkaid94}, \cite{Chapra88} 


%inicio unidad
\nextUnidad{}
\nextCapitulo{}
\nextTema{Soluciones iterativas para encontrar raíces (Método de Newton).}

\cite{Burden02}, \cite{Kinkaid94} 


%inicio unidad
\nextUnidad{}
\nextCapitulo{}
\nextTema{Ajuste de curva, función de aproximación}
...
\nextUnidad{}
\nextCapitulo{}
\nextTema{Diferenciación numérica e integración (regla de Simpson)}
\nextTema{Métodos implícitos y explícitos}

\cite{Burden02}, \cite{Kinkaid94}, \cite{Zill02} 


%inicio unidad
\nextUnidad{}
\nextCapitulo{}
\nextTema{Ecuaciones diferenciales.}
...
\nextUnidad{}
\nextCapitulo{}
\nextTema{Algebra lineal.}
\nextTema{Diferencia finita}
