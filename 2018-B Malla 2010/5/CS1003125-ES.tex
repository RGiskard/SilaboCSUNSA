...
\setNombreAsignatura{Ingeniería de Software I}
\setNombreProfesor{}
...
{CS1003125} %Código de la asignatura
...
{CS1002116,CS1002220,CS1002115} % Prerrequisitos (separados por comas)
...
\cite{Pressman2005}, \cite{Sommerville2008}, \cite{Larman2008} 
...
%inicio unidad
\nextUnidad{\SESoftwareConstruction}
\nextCapitulo{\SESoftwareConstruction}
\nextTema{\SESoftwareConstructionTopicCoding}
\nextTema{\SESoftwareConstructionTopicCodingStandards}
\nextTema{\SESoftwareConstructionTopicIntegration}
\nextTema{\SESoftwareConstructionTopicDevelopment}
\nextTema{\SESoftwareConstructionTopicPotential}
