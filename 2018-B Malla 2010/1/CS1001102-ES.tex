...
\setNombreAsignatura{Estructuras Discretas I}
\setNombreProfesor{}
...
{CS1001102} %Código de la asignatura
...
%inicio unidad
\nextUnidad{\DSSetsRelationsandFunctions}
\nextCapitulo{\DSSetsRelationsandFunctions}
\nextTema{\DSSetsRelationsandFunctionsTopicSets}
\nextTema{% \DSSetsRelationsandFunctionsTopicRelations}
\nextTema{Relaciones:}
\nextTema{Reflexividad, simetria, transitividad}
\nextTema{Relaciones de equivalencia}
\nextTema{Relación de orden parcial y conjuntos parcialmente ordenados}
\nextTema{Elementos extremos de un conjunto parcialmente ordenado}
\nextTema{\DSSetsRelationsandFunctionsTopicFunctions}

\cite{Grimaldi03}, \cite{Rosen2007} 


%inicio unidad
\nextUnidad{\DSBasicLogic}
\nextCapitulo{\DSBasicLogic}
\nextTema{\DSBasicLogicTopicPropositional%}
\nextTema{\DSBasicLogicTopicLogical%}
\nextTema{\DSBasicLogicTopicTruth%}
\nextTema{\DSBasicLogicTopicNormal%}
\nextTema{\DSBasicLogicTopicValidity%}
\nextTema{\DSBasicLogicTopicPropositionalInference%}
\nextTema{\DSBasicLogicTopicPredicate%}
\nextTema{\DSBasicLogicTopicLimitations%}

\cite{Rosen2007}, \cite{Grimaldi03} 


%inicio unidad
\nextUnidad{\DSProofTechniques}
\nextCapitulo{\DSProofTechniques}
\nextTema{\DSProofTechniquesTopicNotions%}
\nextTema{\DSProofTechniquesTopicThe%}
\nextTema{\DSProofTechniquesTopicDirect%}
\nextTema{\DSProofTechniquesTopicDisproving%}
\nextTema{\DSProofTechniquesTopicProof%s}
\nextTema{\DSProofTechniquesTopicInduction%}
\nextTema{\DSProofTechniquesTopicStructural%}
\nextTema{\DSProofTechniquesTopicWeak%}
\nextTema{\DSProofTechniquesTopicRecursive%}
\nextTema{\DSProofTechniquesTopicWell%}

\cite{Rosen2007}, \cite{Epp10}, \cite{Scheinerman12} 


%inicio unidad
\nextUnidad{Representación de Datos}
\nextCapitulo{Representación de Datos}
\nextTema{Representaciones numéricas: signo magnitud, punto flotante.}
\nextTema{Representaciones de otros objetos: conjuntos, relaciones, funciones}
