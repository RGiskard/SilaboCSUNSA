...
\setNombreAsignatura{Comunicación}
\setNombreProfesor{}
...
{FG1001105} %Código de la asignatura
...
\nextTema{La comunicación, definición, relevancia. Elementos. Proceso. Funciones. Clasificación.Comunicación oral y escrita.}
\nextTema{El lenguaje: definición. Características y funciones. Lengua: niveles. Sistema. Norma. Habla. El signo lingüístico: definición, características.}
\nextTema{Multilingüismo en el Perú. Variaciones dialectales en el Perú.}
\nextTema{La palabra: definición, clases y estructura. Los monemas: lexema y morfema. El morfema: clases. La etimología.}
\nextTema{El Artículo académico: Definición, estructura, elección del tema, delimitación del tema.}
