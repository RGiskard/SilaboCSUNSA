...
\setNombreAsignatura{Compiladores}
\setNombreProfesor{}
...
{CS1004247} %Código de la asignatura
...
{CS1004141} % Prerrequisitos (separados por comas)
...
%inicio unidad
\nextUnidad{\PLProgramRepresentation}
\nextCapitulo{\PLProgramRepresentation}
\nextTema{\PLProgramRepresentationTopicPrograms}
\nextTema{\PLProgramRepresentationTopicAbstract}
\nextTema{\PLProgramRepresentationTopicData}
\nextTema{\PLRuntimeSystemsTopicJust}
\nextTema{\PLRuntimeSystemsTopicOther}

\cite{Lou004LP}, \cite{Pratt98} 


%inicio unidad
\nextUnidad{\PLLanguageTranslationandExecution}
\nextCapitulo{\PLLanguageTranslationandExecution}
\nextTema{\PLLanguageTranslationandExecutionTopicInterpretation}
\nextTema{\PLLanguageTranslationandExecutionTopicLanguage}
\nextTema{\PLLanguageTranslationandExecutionTopicRun}
\nextTema{\PLLanguageTranslationandExecutionTopicRunTime}
\nextTema{\PLLanguageTranslationandExecutionTopicMemory}

\cite{Aho2008}, \cite{Aho90}, \cite{Lou004CO}, \cite{Teu98}, \cite{Lem96}, \cite{Appe002} 


%inicio unidad
\nextUnidad{\PLSyntaxAnalysis}
\nextCapitulo{\PLSyntaxAnalysis}
\nextTema{\PLSyntaxAnalysisTopicScanning}
\nextTema{\PLSyntaxAnalysisTopicParsing}
\nextTema{\PLSyntaxAnalysisTopicGenerating}

\cite{Aho2008}, \cite{Aho90}, \cite{Lou004CO}, \cite{Teu98}, \cite{Lem96}, \cite{Appe002} 


%inicio unidad
\nextUnidad{\PLCompilerSemanticAnalysis}
\nextCapitulo{\PLCompilerSemanticAnalysis}
\nextTema{\PLCompilerSemanticAnalysisTopicHigh}
\nextTema{\PLCompilerSemanticAnalysisTopicScope}
\nextTema{\PLCompilerSemanticAnalysisTopicType}
\nextTema{\PLCompilerSemanticAnalysisTopicDeclarative}

\cite{Aho2008}, \cite{Aho90}, \cite{Lou004CO}, \cite{Teu98}, \cite{Lem96}, \cite{Appe002} 


%inicio unidad
\nextUnidad{\PLCodeGeneration}
\nextCapitulo{\PLCodeGeneration}
\nextTema{\PLCodeGenerationTopicProcedure}
\nextTema{\PLCodeGenerationTopicSeparate}
\nextTema{\PLCodeGenerationTopicInstruction}
\nextTema{\PLCodeGenerationTopicInstructionScheduling}
\nextTema{\PLCodeGenerationTopicRegister}
\nextTema{\PLCodeGenerationTopicPeephole}
