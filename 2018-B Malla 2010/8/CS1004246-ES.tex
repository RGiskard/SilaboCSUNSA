...
\setNombreAsignatura{Aspectos Sociales y Profesionales de la Computación}
\setNombreProfesor{}
...
{CS1004246} %Código de la asignatura
...
%inicio unidad
\nextUnidad{\SPHistory}
\nextCapitulo{\SPHistory}
\nextTema{\SPHistoryTopicPrehistory}
\nextTema{\SPHistoryTopicHistory}
\nextTema{\SPHistoryTopicPioneers}
\nextTema{\SPHistoryTopicHistoryOf}

\cite{LaudonLaudon}, \cite{McLeod} 


%inicio unidad
\nextUnidad{\SPSocialContext}
\nextCapitulo{\SPSocialContext}
\nextTema{\SPSocialContextTopicSocial}
\nextTema{\SPSocialContextTopicImpact}
\nextTema{\SPSocialContextTopicGrowth}
\nextTema{\SPSocialContextTopicOften}
\nextTema{\SPSocialContextTopicAccessibility}
\nextTema{\SPSocialContextTopicContext}

\cite{LaudonLaudon}, \cite{McLeod} 


%inicio unidad
\nextUnidad{\SPAnalyticalTools}
\nextCapitulo{\SPAnalyticalTools}
\nextTema{\SPAnalyticalToolsTopicEthical}
\nextTema{\SPAnalyticalToolsTopicEthicalTheories}
\nextTema{\SPAnalyticalToolsTopicMoral}

\cite{LaudonLaudon}, \cite{McLeod} 


%inicio unidad
\nextUnidad{\SPProfessionalEthics}
\nextCapitulo{\SPProfessionalEthics}
\nextTema{\SPProfessionalEthicsTopicCommunity}
\nextTema{\SPProfessionalEthicsTopicThe}
\nextTema{\SPProfessionalEthicsTopicKeeping}
\nextTema{\SPProfessionalEthicsTopicProfessional}
\nextTema{\SPProfessionalEthicsTopicAccountability}
\nextTema{\SPProfessionalEthicsTopicTheRole}
\nextTema{\SPProfessionalEthicsTopicMaintaining}
\nextTema{\SPProfessionalEthicsTopicEthicalDissent}
\nextTema{\SPProfessionalEthicsTopicTheRelationship}
\nextTema{\SPProfessionalEthicsTopicDealing}
\nextTema{\SPProfessionalEthicsTopicForms}
\nextTema{\SPProfessionalEthicsTopicAcceptable}
\nextTema{\SPProfessionalEthicsTopicErgonomics}
\nextTema{\SPProfessionalEthicsTopicTime}

\cite{LaudonLaudon}, \cite{McLeod}, \cite{Datamation}, \cite{DigitalEconomy}, \cite{FinancialTimes} 


%inicio unidad
\nextUnidad{\SPIntellectualProperty}
\nextCapitulo{\SPIntellectualProperty}
\nextTema{\SPIntellectualPropertyTopicPhilosophical}
\nextTema{\SPIntellectualPropertyTopicIntellectual}
\nextTema{\SPIntellectualPropertyTopicIntangible}
\nextTema{\SPIntellectualPropertyTopicLegal}
\nextTema{\SPIntellectualPropertyTopicDigital}
\nextTema{\SPIntellectualPropertyTopicCopyrights}
\nextTema{\SPIntellectualPropertyTopicPlagiarism}
\nextTema{\SPIntellectualPropertyTopicFoundations}
\nextTema{\SPIntellectualPropertyTopicSoftware}

\cite{LaudonLaudon}, \cite{McLeod}, \cite{Datamation}, \cite{DigitalEconomy}, \cite{FinancialTimes} 


%inicio unidad
\nextUnidad{\SPPrivacyandCivilLiberties}
\nextCapitulo{\SPPrivacyandCivilLiberties}
\nextTema{\SPPrivacyandCivilLibertiesTopicPhilosophicalFoundations}
\nextTema{\SPPrivacyandCivilLibertiesTopicLegalFoundations}
\nextTema{\SPPrivacyandCivilLibertiesTopicPrivacy}
\nextTema{\SPPrivacyandCivilLibertiesTopicRamifications}
\nextTema{\SPPrivacyandCivilLibertiesTopicTechnology}
\nextTema{\SPPrivacyandCivilLibertiesTopicPrivacyLegislation}
\nextTema{\SPPrivacyandCivilLibertiesTopicCivil}
\nextTema{\SPPrivacyandCivilLibertiesTopicFreedom}

\cite{LaudonLaudon}, \cite{McLeod}, \cite{Datamation}, \cite{DigitalEconomy}, \cite{FinancialTimes} 


%inicio unidad
\nextUnidad{\SPSecurityPoliciesLawsandComputerCrimes}
\nextCapitulo{\SPSecurityPoliciesLawsandComputerCrimes}
\nextTema{\SPSecurityPoliciesLawsandComputerCrimesTopicExamples}
\nextTema{\SPSecurityPoliciesLawsandComputerCrimesTopicSocial}
\nextTema{\SPSecurityPoliciesLawsandComputerCrimesTopicIssues}
\nextTema{\SPSecurityPoliciesLawsandComputerCrimesTopicMotivations}
\nextTema{\SPSecurityPoliciesLawsandComputerCrimesTopicEffects}
\nextTema{\SPSecurityPoliciesLawsandComputerCrimesTopicCrime}
\nextTema{\SPSecurityPoliciesLawsandComputerCrimesTopicSecurity}

\cite{LaudonLaudon}, \cite{McLeod}, \cite{Datamation}, \cite{DigitalEconomy}, \cite{FinancialTimes} 


%inicio unidad
\nextUnidad{\SPEconomiesofComputing}
\nextCapitulo{\SPEconomiesofComputing}
\nextTema{\SPEconomiesofComputingTopicMonopolies}
\nextTema{\SPEconomiesofComputingTopicEffect}
\nextTema{\SPEconomiesofComputingTopicPricing}
\nextTema{\SPEconomiesofComputingTopicThePhenomenon}
\nextTema{\SPEconomiesofComputingTopicConsequences}
\nextTema{\SPEconomiesofComputingTopicDifferences}
\nextTema{\SPEconomiesofComputingTopicCost}
\nextTema{\SPEconomiesofComputingTopicCostEstimates}
\nextTema{\SPEconomiesofComputingTopicEntrepreneurship}
\nextTema{\SPEconomiesofComputingTopicNetwork}
\nextTema{\SPEconomiesofComputingTopicUse}
