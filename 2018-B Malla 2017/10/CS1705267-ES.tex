...
\setNombreAsignatura{Trabajo Interdisciplinar III}
\setNombreProfesor{}
...
{CS1705267} %Código de la asignatura
...
{XD1703240} % Prerrequisitos (separados por comas)
...
\begin{sumilla}
\item Proyecto Interdisciplinario III 
...
%inicio unidad
\nextUnidad{Proyecto Interdisciplinario III }
\nextCapitulo{Proyecto Interdisciplinario III }
\nextTema{Desarrollar ideas relacionas a las multiples discipiplinas  que aproximen al alumno a una idea real de una empresa.}
