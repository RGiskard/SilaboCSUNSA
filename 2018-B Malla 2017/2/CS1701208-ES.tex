...
\setNombreAsignatura{Estructuras Discretas II}
\setNombreProfesor{}
...
{CS1701208} %Código de la asignatura
...
{CS1701107,CS1701106} % Prerrequisitos (separados por comas)
...
\begin{sumilla}
\item Lógica Digital y Representación de Datos
\item \DSBasicsofCounting
...
%inicio unidad
\nextUnidad{Lógica Digital y Representación de Datos}
\nextCapitulo{Lógica Digital y Representación de Datos}
\nextTema{Retículo: Tipos y propiedades.}
\nextTema{Álgebras booleanas.}
\nextTema{Funciones y expresiones booleanas.}
\nextTema{Representación de las funciones booleanas: Disjuntiva normal y conjuntiva normal.}
\nextTema{Puertas Lógicas.}
\nextTema{Minimización del Circuito.}

\cite{Rosen2007}, \cite{Grimaldi03} 


%inicio unidad
\nextUnidad{\DSBasicsofCounting}
\nextCapitulo{\DSBasicsofCounting}
\nextTema{\DSBasicsofCountingTopicCounting}
\nextTema{\DSBasicsofCountingTopicThePigeonhole}
\nextTema{\DSBasicsofCountingTopicPermutations}
\nextTema{\DSBasicsofCountingTopicSolving}
\nextTema{\DSBasicsofCountingTopicBasic}
