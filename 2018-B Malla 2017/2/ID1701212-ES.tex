...
\setNombreAsignatura{Inglés técnico profesional II}
\setNombreProfesor{}
...
{ID1701212} %Código de la asignatura
...
{ID1701105} % Prerrequisitos (separados por comas)
...
%inicio unidad
\nextUnidad{How long ago?}
\nextCapitulo{How long ago?}
\nextTema{Pasado Simple}
\nextTema{Oraciones Negativas con ago.}
\nextTema{Conjunciones}
\nextTema{Expresiones de Tiempo en pasado}
\nextTema{Relaciones y sí­mbolos fonéticos}
\nextTema{Expresiones para dar la fecha}

\cite{Soars021S}, \cite{Cambridge06}, \cite{MacGrew99} 


%inicio unidad
\nextUnidad{Food you like!}
\nextCapitulo{Food you like!}
\nextTema{Sustantivos Contables y No Contables}
\nextTema{Expresiones con Would like y I'd like}
\nextTema{Cuantificadores}
\nextTema{Comidas alrededor del mundo}
\nextTema{Pedidos formales}
\nextTema{Cartas formales}

\cite{Soars021S}, \cite{Cambridge06}, \cite{MacGrew99} 


%inicio unidad
\nextUnidad{The world of work}
\nextCapitulo{The world of work}
\nextTema{Adjetivos}
\nextTema{Oraciones con Adjetivos Comparativos.}
\nextTema{Oraciones con Adjetivos Superlativos}
\nextTema{Ciudades y el campo}
...
%inicio unidad
\nextUnidad{Looking good!}
\nextCapitulo{Looking good!}
\nextTema{Presente Continuo}
\nextTema{Oraciones Afirmativas, Negativas y Preguntas}
\nextTema{Uso de Whose}
\nextTema{Pronombres Posesivos}
\nextTema{Ropa y colores}
\nextTema{Expresiones a usar en tiendas de ropa}
\nextTema{Símbolos fonéticos.}

\cite{Soars021S}, \cite{Cambridge06}, \cite{MacGrew99} 


%inicio unidad
\nextUnidad{Life is an adventure!}
\nextCapitulo{Life is an adventure!}
\nextTema{Uso de going to}
\nextTema{Oraciones en Tiempo Futuro}
\nextTema{Expresiones de Cantidad.}
\nextTema{Verbos de acción}
\nextTema{Vocabulario del clima}
\nextTema{Expresiones de Sugerencia}
\nextTema{Escribir una postal}

\cite{Soars021S}, \cite{Cambridge06}, \cite{MacGrew99} 


%inicio unidad
\nextUnidad{You`re pretty smart!}
\nextCapitulo{You`re pretty smart!}
\nextTema{Formas de Preguntas}
\nextTema{Adverbios y Adjetivos}
\nextTema{Vocabulario descripción de sentimientos}
\nextTema{Expresiones para viajes en tren}
\nextTema{Redacción de historias cortas}
\nextTema{Lecturas.}
...
%inicio unidad
\nextUnidad{Have you ever?}
\nextCapitulo{Have you ever?}
\nextTema{Presente Perfecto}
\nextTema{Expresiones con never, ever y yet}
\nextTema{Vocabulario verbos en Participio pasado}
\nextTema{Expresiones para viajes en avión}
\nextTema{Redacción de cartas de agradecimiento}
\nextTema{Lecturas}
