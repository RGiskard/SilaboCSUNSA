...
\setNombreAsignatura{Ecología y Conservación Ambiental}
\setNombreProfesor{}
...
{FG1702229} %Código de la asignatura
...
%inicio unidad
\nextUnidad{Desafíos Globales}
\nextCapitulo{Desafíos Globales}
\nextTema{Pasos de DT.}
\nextTema{Técnica y usos del Brainstorm.}
\nextTema{Conocimiento del usuario, empatía y uso de arquetipos.}
\nextTema{Tipos de Investigación, diferencias y usos.}
\nextTema{Estrategias de recolección de Insights.}
\nextTema{Métodos de Ideación.}
\nextTema{Introducción al Prototipado.}
\nextTema{Introducción a la Experiencia de Usuario.}
\nextTema{Estrategias de Testeo e Iteración}
\nextTema{Usos del Storytelling}

\cite{Curedale12}, \cite{Upton15} 
