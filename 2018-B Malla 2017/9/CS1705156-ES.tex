...
\setNombreAsignatura{Proyecto de Final de Carrera II}
\setNombreProfesor{}
...
{CS1705156} %Código de la asignatura
...
{CS1704249} % Prerrequisitos (separados por comas)
...
%inicio unidad
\nextUnidad{Proyecto de Tesis}
\nextCapitulo{Proyecto de Tesis}
\nextTema{Proyecto de Tesis.}

\cite{ieee}, \cite{acm}, \cite{citeseer} 


%inicio unidad
\nextUnidad{Avance de Tesis}
\nextCapitulo{Avance de Tesis}
\nextTema{Avance de Tesis.}
