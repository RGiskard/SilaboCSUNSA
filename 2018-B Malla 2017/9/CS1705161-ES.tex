...
\setNombreAsignatura{Topicos en Ciencia de Datos}
\setNombreProfesor{}
...
{CS1705161} %Código de la asignatura
...
{MA1703134} % Prerrequisitos (separados por comas)
...
\nextTema{Introducción a la gestión de la información}
\nextTema{Software para gestión de información.}
\nextTema{Tecnología para gestión de información.}

\cite{Sommerville2010}, \cite{Pressman2014} 


%inicio unidad
\nextUnidad{Estrategia}
\nextCapitulo{Estrategia}
\nextTema{Estrategia para gestión de información}
\nextTema{Estrategia para gestión conocimiento}
\nextTema{Estrategia para sistema de información.}

\cite{Sommerville2010}, \cite{Pressman2014} 


%inicio unidad
\nextUnidad{Implementación}
\nextCapitulo{Implementación}
\nextTema{Gestión de desarrollo de sistemas de información.}
\nextTema{Gestión del cambio}
\nextTema{Arquitectura de Información}
